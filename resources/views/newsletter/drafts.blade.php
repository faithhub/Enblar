                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Draft Newsletter</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card card-primary card-outline">
                            ...
                            <!-- /.card-header -->
                            <form class="needs-validation" novalidate role="form" method="post" id="form" action="{{ url('drafts/'.$news->id) }}">
                                @csrf
                                <div class="card-body">
                                    <div class="p-2 text-center" id="output"></div>
                                    <div class="form-group">
                                        <label>Subject</label>
                                        <input type="text" value="{{ $news->subject }}" name="subject" class="form-control" placeholder="Subject:" required>
                                    ...
                                    <div class="form-group">
                                        <label>Body</label>
                                        <textarea name="bodyMessage" class="form-control" style="height: 300px">{{ $news->bodyMessage }}</textarea>
                                        @error('bodyMessage')
                                        <span style="color: red;">{{$message}}</span>
                                        @enderror
                                    </div>
