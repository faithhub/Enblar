                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">All Sent Newsletters</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">All Sent Newsletters</h3>
                                <!-- /.card-tools -->
                            </div>
                            <!-- /.card-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td class="mailbox-name"><a href="{{ url('newsletter/'.$item->id) }}" ><b>{{$item['subject']}}</b></a></td>
                                                <td >
                                                    @if($item['status'] == 'sent')
